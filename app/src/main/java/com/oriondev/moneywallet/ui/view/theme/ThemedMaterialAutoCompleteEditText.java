...
/**
 * Themed version of MaterialAutoCompleteEditText that applies theme colors.
 */
public class ThemedMaterialAutoCompleteEditText extends MaterialAutoCompleteEditText implements ThemeEngine.ThemeConsumer {

    private BackgroundColor mBackgroundColor;

    public ThemedMaterialAutoCompleteEditText(Context context) {
        super(context);
        initialize(context, null, 0);
    }

    public ThemedMaterialAutoCompleteEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize(context, attrs, 0);
    }

    public ThemedMaterialAutoCompleteEditText(Context context, AttributeSet attrs, int defStyleAttr) {
